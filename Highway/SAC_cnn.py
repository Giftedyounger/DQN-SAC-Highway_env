...
class PolicyNet(nn.Module):
    def __init__(self, state_dim, action_dim):
        ...
        hidden_dim_1 = 64
        hidden_dim_2 = 64
        self.fc1 = nn.Linear(4 * 3 * 3, hidden_dim_1)  # 128
...
class QValueNet(nn.Module):
    def __init__(self, state_dim, action_dim):
        ...
        hidden_dim_1 = 64
        hidden_dim_2 = 64
        self.fc1 = nn.Linear(4 * 3 * 3, hidden_dim_1)
...
class SAC_cnn(nn.Module):
    ...
    def choose_action(self, state):
        ...
        state = state.reshape(1, 1, 5, self.state_dim // 5)
    ...
    def train(self, num_epochs):
        ...
        for epoch in range(int(num_epochs)):
            ...
            while not done:
                ...
                state_next_batch = torch.FloatTensor([exp["state_next"] for exp in exp_batch])
            ...
            if epoch % period == 0:
                ...
                try:
                    ...
                    pass
                np.save(self.timestamp + "/SAC_cnn_loss.npy", loss_list)
                np.save(self.timestamp + "/SAC_cnn_avg_reward.npy", avg_reward_list)
...
if __name__ == "__main__":
    ...
    # Train the policy
    iterations = 1000
    avg_loss, avg_reward_list = SAC_cnn_object.train(iterations)
    np.save(time_string + "/SAC_cnn_loss.npy", avg_loss)
    np.save(time_string + "/SAC_cnn_avg_reward.npy", avg_reward_list)
